    ...
    <>
      ...
      <section className="testimonial-section d-flex align-items-center ">
        <div className="container">
          <h1 className="testi-header text-capitalized headerTitle">The Shibex's</h1>
              ...
              >
                <div className="carousel-inner text-light">
                  <div className="carousel-item testi-item active">
                    <h3 className="text-center mb-5 teamMates fontName">Raphael</h3>
                  ...
                  <div className="carousel-item testi-item">
                    <h3 className="text-center mb-5 teamMates fontName">Nath</h3>
                    <span className="paragraph fw-bolder ">
                  ...
                  <div className="carousel-item testi-item">
                    <h3 className="text-center mb-5 teamMates fontName">Yosef</h3>
                    <span className="paragraph fw-bolder ">
                  ...
                  <div className="carousel-item testi-item">
                    <h3 className="text-center mb-5 teamMates fontName">Ubab</h3>
                    <span className="paragraph fw-bolder ">
